    ...
    "sections": [
      {
        ...
        "figures": [
          ...
          { "src": "images-handbook/speed-sign-variable.png", "caption": "Variable electronic signs — change with road conditions.", "wide": true, "scale": 2 },
    ...
    "sections": [
      ...
      },
      {
        ...
        "figures": [
          ...
          { "src": "images-handbook/left-only-sign.jpg", "caption": "'Left only' sign: you must turn left.", "scale": 1.5 },
          { "src": "images-handbook/right-only-sign.jpg", "caption": "'Right only' sign: you must turn right.", "scale": 1.5 },
  ...
  },
  {
    ...
    "sections": [
      ...
      },
      {
        ...
        "page": 160,
        "figures": [
          { "src": "images-handbook/no-stopping-sign.jpg", "caption": "'No stopping' sign: no stopping to the left or right of the sign.", "detail": "Bans stopping anywhere along the kerb in the arrow's direction except emergencies; may apply only at certain times" },
          { "src": "images-handbook/clearway-end-signs.jpg", "caption": "You must not park between a 'Clearway' and 'End clearway' sign during the times shown.", "wide": true, "detail": "Bans stopping between signed times except emergencies; buses/taxis (not rideshare) may still stop briefly" },
          { "src": "images-handbook/motorcycle-parking-sign.jpg", "caption": "Motorcycle parking sign — motorcycle-only between the signs.", "detail": "Motorcycle-only between the signs; any vehicle may briefly stop for passengers" },
          { "src": "images-handbook/special-event-clearway-sign-a.jpg", "caption": "Special event clearway sign.", "wide": true, "detail": "Bans parking during the shown dates/times" },
          { "src": "images-handbook/special-event-clearway-sign-b.jpg", "caption": "Special event clearway sign, roadside version.", "wide": true, "detail": "Bans parking during the shown dates/times" },
          { "src": "images-handbook/restricted-parking-area-signs.jpg", "caption": "'Restricted parking area' and 'End restricted parking area' signs.", "wide": true, "detail": "Bans stopping/parking between start/end signs (except where separately signed); may still drop off/pick up" },
          { "src": "images-handbook/hourly-parking-signs.jpg", "caption": "Hourly parking signs (7P, quarter-hour, unlimited) show the days and hours parking is allowed.", "detail": "Allowed during shown days/hours, and outside them too unless another sign says otherwise" },
          { "src": "images-handbook/ev-parking-signs-top.jpg", "caption": "EV parking — some spots allow any EV, others only while charging.", "wide": true, "detail": "EVs only, sometimes only while charging, sometimes only during signed hours" },
          { "src": "images-handbook/ev-parking-signs-bottom.jpg", "caption": "EV parking — time-limited spots, some only while charging.", "wide": true, "detail": "EVs only, sometimes only while charging, sometimes only during signed hours" },
          { "src": "images-handbook/accessible-parking-sign.jpg", "caption": "Accessible parking sign — requires a current Mobility Parking Scheme (MPS) permit.", "wide": true, "detail": "Needs a current MPS permit displayed; permit holders also get extended time elsewhere" },
          { "src": "images-handbook/special-event-parking-area-sign.jpg", "caption": "Special event parking area sign — capped parking time unless you hold a permit.", "detail": "Caps parking time to what's shown, unless you hold a permit" },
          { "src": "images-handbook/australia-post-box-parking.jpg", "caption": "Parking at least 3m away from an Australia Post box.", "span": 4, "detail": "No parking within 3m (can stop briefly to post mail or for passengers)" },
          { "src": "images-handbook/taxi-zone-sign.jpg", "caption": "Taxi zone sign — taxi zone on both sides of the sign.", "detail": "Bans other vehicles stopping in the arrow's direction (except taxis/buses), outside signed times" },
          { "src": "images-handbook/bus-zone-sign.jpg", "caption": "Bus zone sign — bus zone on both sides of the sign.", "detail": "Bans other vehicles stopping in the arrow's direction (except taxis/buses), outside signed times" },
          { "src": "images-handbook/loading-zone-sign.jpg", "caption": "Loading zone sign — loading zone to the left of the sign.", "detail": "Goods vehicles ≤30 min for goods; buses ≤30 min for passengers; any vehicle may stop briefly for passengers" },
          { "src": "images-handbook/works-zone-sign.jpg", "caption": "Works zone sign — works zone to the left of the sign.", "detail": "Bans parking unless used in the nearby construction work; any vehicle may stop briefly for passengers" },
          { "src": "images-handbook/truck-zone-sign.jpg", "caption": "Truck zone sign — truck zone to the left of the sign.", "detail": "Bans stopping/parking during signed hours unless a 4.5t+ GVM truck loading; any vehicle may stop briefly for passengers" }
        ],
        "figuresGrid": { "cols": 4 },
        "bullets": [],
        "tables": [
    ...
    "sections": [
      {
        ...
        "figures": [
          ...
          { "src": "images-handbook/sharp-bend-left-sign.jpg", "caption": "Sharp bend to the left ahead." },
          { "src": "images-handbook/winding-road-sign.jpg", "caption": "Winding road ahead.", "newRow": true },
          { "src": "images-handbook/road-divides-sign.jpg", "caption": "Road divides ahead." },
          { "src": "images-handbook/divided-road-ends-sign.jpg", "caption": "Divided road ends ahead." },
          { "src": "images-handbook/road-narrows-sign.jpg", "caption": "Road narrows ahead." },
          { "src": "images-handbook/give-way-ahead-sign.jpg", "caption": "'Give way' sign ahead.", "newRow": true },
          { "src": "images-handbook/stop-ahead-sign.jpg", "caption": "'Stop' sign ahead." },
          { "src": "images-handbook/pedestrian-crossing-ahead-sign2.jpg", "caption": "Pedestrian crossing ahead." },
          { "src": "images-handbook/pedestrians-may-cross-ahead-sign.jpg", "caption": "Pedestrians may be crossing ahead." },
          { "src": "images-handbook/children-may-cross-sign.jpg", "caption": "Children may be crossing.", "newRow": true },
          { "src": "images-handbook/bicycles-ahead-sign.jpg", "caption": "Look out for bicycles." },
          { "src": "images-handbook/slippery-when-wet-sign.jpg", "caption": "Road slippery when wet." },
          { "src": "images-handbook/steep-descent-sign.jpg", "caption": "Steep descent." },
          { "src": "images-handbook/slow-moving-vehicles-sign.jpg", "caption": "Slow-moving vehicles.", "newRow": true },
          ...
          { "src": "images-handbook/livestock-crossing-sign.jpg", "caption": "Livestock may be crossing ahead.", "newRow": true },
          { "src": "images-handbook/stock-crossing-sign.jpg", "caption": "Road ahead is used for stock crossing." },
          { "src": "images-handbook/ford-sign.jpg", "caption": "Ford ahead (a dip that may be covered by water)." },
          { "src": "images-handbook/grid-ahead-sign.jpg", "caption": "Grid ahead (a row of bars set into the road)." },
